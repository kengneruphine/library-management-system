	...
	<div>
	  ...
	  <div class="col s1 m1">.</div>
	   <div class="col s3 m3">
          ...
          <div class="card-image">
            ...
            <div class="card-title"> Grace Scintiche</div></br>
              <div class="card-content">
                Here is the chief Designer of the website.
              </div>
            </div>
          </div>
        ...
        <div class="card-panel">
            <div class="card-image">
              <img src="css/images/cou4.jpg" alt="" class="circle responsive-img"> <!-- notice the "circle" class -->
            </div>
               <div class="card-title"> Courage Angieh</div></br>
              <div class="card-content">
                Assisted in the Designing
            </div>
          </div>
        </div>
	   ...
	   <div class="col s3 m3" >
        ...
        <div class="card-panel">
          <div class="card-image">
              ...
              <div class="card-content">
                She works in collaboration with the Manager
              </div>
            </div>
          </div>
        ...
        <div class="card-panel">
            <div class="card-image">
             ...
             <div class="card-title"> Divine Ngocho</div></br>
              <div class="card-content">
                Here is the Manager of the library
            </div>
          </div>
        </div>
		<div class="col s2 m2">.</div>
